...
public class RAPredicatable implements RAPredicate<RAPredicatable> {

    private final String TAG = RAPredicatable.class.getSimpleName();
    ...
    @Override
    public RAPredicatable select(String name, Class aClass) {
        varialbeName = name;
        mClass = aClass;
        return this;
    }
    ...
    @Override
    public RAPredicatable greaterThen(int i) {
        greater = i;
        return this;
    }

    @Override
    public RAPredicatable smallerThen(int i) {
        smaller = i;
        return this;
    }

    @Override
    public RAPredicatable rEqualTo(Object o) {
        mEquals = o;
        return this;
    }

    @Override
    public RAPredicatable rContatins(Object o) {
        mContains =o;
        return this;
    }

    @Override
    public RAPredicatable inverse() {
        inverse =true;
        return this;
    }
